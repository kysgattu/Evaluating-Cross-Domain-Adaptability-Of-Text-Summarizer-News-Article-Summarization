...
entertainment = pd.read_csv('../FinalCodeBase/data/BBCNewsSummaryCSV/entertainment_data.csv')
sport = pd.read_csv('../FinalCodeBase/data/BBCNewsSummaryCSV/sport_data.csv')
tech = pd.read_csv('../FinalCodeBase/data/BBCNewsSummaryCSV/tech_data.csv')
business = pd.read_csv('../FinalCodeBase/data/BBCNewsSummaryCSV/business_data.csv')
politics = pd.read_csv('../FinalCodeBase/data/BBCNewsSummaryCSV/politics_data.csv')
